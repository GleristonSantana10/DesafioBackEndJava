...
public abstract class AbstractServices<T, PK extends Serializable> implements Serializable {

	private static Logger LOGGER = LoggerFactory.getLogger(AbstractServices.class);
